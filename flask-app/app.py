...
from src.Prediction.predictionFile import Prediction_Pipeline
...
def predict():
    if request.method=="GET":
        ...
        PredictionPipelineObj =  Prediction_Pipeline()
        output = PredictionPipelineObj.receiveDataFromUI(Airline=Airline,Date_of_Journey=Date_of_Journey,Source=Source,
